<div class="btn-group" style="margin-right: 10px" data-toggle="buttons">
    <label class="btn btn-sm btn-dropbox <?php echo e($btn_class, false); ?> <?php echo e($expand ? 'active' : '', false); ?>">
        <input type="checkbox"><i class="fa fa-filter"></i>&nbsp;&nbsp;<?php echo e(trans('admin.filter'), false); ?>
