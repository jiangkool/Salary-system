...
<div class="wrapper">
    ...
    <?php echo $__env->make('admin::partialsb.header', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>

    <?php echo $__env->make('admin::partialsb.sidebar', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
    ...
    <?php echo $__env->make('admin::partialsb.footer', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
